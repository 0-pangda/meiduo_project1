...
_accountSid = '8a216da86bfdbebb016db91c3af30521'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '6c94064c63df4995a148d2241ea0d1cc'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8aaf07086dae7e1f016db92067df086b'
...
# if __name__ == '__main__':
    ...
    # 单例类发送短信验证码
    # CCP().send_template_sms('13103068506', ['123456', 5], 1)
